...
import { InfoContainer, Logo, InfoContent, LogoContainer, Title, Paragraph } from "./styled";
...
const Info = () => {
  ...
  return (
    <InfoContainer>
      ...
      <InfoContent>
        <Paragraph>
          Witaj na Lokalnym Bazarku! To miejsce, gdzie łączymy się z lokalnymi rolnikami, producentami i przetwórcami, wspierając ich pasję i wysiłek. Jest to miejsce, gdzie możecie przesyłać oraz szukać oferty świeżych warzyw, owoców, pieczywa, ręcznie robionych serów, ciast, soków, przetworów, tradycyjnych wędlin, mięs i kiełbas, unikalnych rękodzieł oraz roślin ozdobnych oraz sadzonki warzyw i owoców.
